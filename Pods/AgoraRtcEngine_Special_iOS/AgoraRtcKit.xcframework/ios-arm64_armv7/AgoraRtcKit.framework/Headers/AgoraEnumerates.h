...
typedef NS_ENUM(NSInteger, AgoraErrorCode) {
    ...
    */
    ...
    AgoraErrorCodeCertVerifyFailure = 135,
...
typedef NS_ENUM(NSInteger, AgoraVideoCodecCapabilityLevel) {
  ...
  AgoraVideoCodecCapabilityLevel2k30fps = 23,
  AgoraVideoCodecCapabilityLevel2k60fps = 26,
...
typedef NS_ENUM(NSInteger, AgoraAudioFileRecordingType) {
    ...
    AgoraAudioFileRecordingTypePublish = 4,
};
...
typedef NS_ENUM(NSInteger, AgoraAudioEncodedFrameDelegatePosition) {
    ...
    /** publish audio file recording. */
    AgoraAudioEncodedFrameObserverPositionPublish = 4,
};
...
typedef NS_ENUM(NSInteger, AgoraAudioOutputRouting) {
    ...
    /**
     * 10: Bluetooth Speaker via a2dp.
     */
    AgoraAudioOutputRoutingBluetoothSpeaker = 10
};
...
typedef NS_ENUM(NSInteger, AgoraAudioEffectPreset) {
   ...
   */
  AgoraAudioEffectPresetOffHarmony = 0x02010120,
  ...
  /** An audio effect typical of a KTV venue for backing vocals.
   *
   ...
   * setting this enumerator.
   */
  AgoraAudioEffectPresetRoomAcousticsKTVHarmony = 0x02010110,
  ...
  /** An audio effect typical of a concert hall for backing vocals.
   *
   ...
   * setting this enumerator.
   */
  AgoraAudioEffectPresetRoomAcousVocalConcerHarmony = 0x02010210,
   ...
   * setting this enumerator.
   */
  AgoraAudioEffectPresetRoomAcousStudioHarmony = 0x02010310,
   ...
   * setting this enumerator.
   */
  AgoraAudioEffectPresetRoomAcousPhonographHarmony = 0x02010410,
...
typedef NS_OPTIONS(NSUInteger, AgoraAudioFramePosition) {
  ...
  /** The position for observing the before-publishing audio of the local user
   [onPublishAudioFrame]([AgoraAudioFrameDelegate onPublishAudioFrame:]) callback.
   */
  AgoraAudioFramePositionPublish = 1 << 5,
};
