 ...
 * - false: The recorded audio frame is invalid and is not encoded or sent.
 */
- (BOOL)onPublishAudioFrame:(AgoraAudioFrame* _Nonnull)frame channelId:(NSString * _Nonnull)channelId  NS_SWIFT_NAME(onPublishAudioFrame(_:channelId:));
...
- (AgoraAudioParams* _Nonnull)getPublishAudioParams NS_SWIFT_NAME(getPublishAudioParams());
...
/**
 * Occurs when the publish audio data is received.
 */
- (void)onPublishEncodedAudioFrame:(NSData* _Nonnull)frameData info:(AgoraEncodedAudioFrameInfo* _Nonnull) info; 
@end
...
- (int)setPublishAudioFrameParametersWithSampleRate:(NSInteger)sampleRate
                                              channel:(NSInteger)channel
